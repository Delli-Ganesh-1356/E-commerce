...
<h3>Select way of Payment</h3>
 <select class="input-style" name="payentMethod">
...
<div class="right-div">
<h3>Pay online on this shopy@pay.com</h3>
<input  class="input-style"  type="text" name="transaction"placeholder="Enter transaction ID"> 
...
<button class="button">Proceed to generate bill & save</button><i class='far fa-arrow-alt-circle-right'></i>
